<template>
  <div class="relative flex items-center justify-center p-10 mx-auto text-sm text-center text-gray-500">
    <span class="items-center hidden px-3 sm:inline-flex">
      Made with
      <svg viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4 mx-1 text-red-300"><path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd" /></svg>
      by
      <a class="ml-1 text-gray-500 underline" rel="noopener" href="https://github.com/22940dev/" target="_blank">22940dev</a>
    </span>
    <nuxt-link to="/about" class="px-3 text-gray-500 underline border-gray-700 sm:border-l">
      About
    </nuxt-link>
    <a rel="noopener" href="https://github.com/22940dev/moviejs-search" target="_blank" class="inline-flex items-center px-3 text-gray-500 underline border-l border-gray-700">
